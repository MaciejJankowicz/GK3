// GK3_4.cpp : Defines the entry point for the console application.
//
...
void GenerateTextures()
{
	...
	//
	// wczytanie tekstury c_20110521042857H_SS9.tga
...
void GenerateDisplayLists()
{
	...
	// prawa boczna ściana
	glTexCoord2f(0.0, 0.0);
	glVertex3f(1.001f, 1.0, -1.0);
	glTexCoord2f(2.0, 0.0);
	glVertex3f(1.001f, 1.0, 1.0);
	glTexCoord2f(2.0, 1.0);
	glVertex3f(1.001f, 0.0, 1.0);
	glTexCoord2f(0.0, 0.0);
	glVertex3f(1.001f, 1.0, -1.0);
	glTexCoord2f(2.0, 1.0);
	glVertex3f(1.001f, 0.0, 1.0);
